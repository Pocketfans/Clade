...
export const MortalitySection = memo(function MortalitySection({
  ...
  return (
    <div className="section-page">
      ...
      {/* 压力上限 */}
      <Card title="压力上限" icon="📊" desc="各类压力因素的最大影响值">
      ...
      {/* 权重配置 */}
      <Card title="权重配置" icon="⚖️" desc="加权模型中各压力因素的权重">
      ...
      {/* 乘法模型系数 */}
      <Card title="乘法模型系数" icon="✖️" desc="乘法死亡率模型的系数">
        <div className="card-grid">
          <SliderRow
            label="环境乘数"
      ...
      {/* 模型混合 */}
      <Card title="模型混合" icon="🔀" desc="加权模型与乘法模型的混合比例">
        <SliderRow
          label="加权模型权重"
      ...
      {/* 抗性系数 */}
      <Card title="抗性系数" icon="🛡️" desc="体型和世代对死亡率的抵抗">
        <div className="card-grid">
          <SliderRow
            label="体型抗性/10cm"
