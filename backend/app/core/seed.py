...
A_SCENARIO = [
    {
        ...
        "morphology_stats": {
            ...
            # 鞭毛虫生物量约 2e6 * 3e-9 = 0.006g
            # 按12%生态效率，需要微藻生物量 = 0.006 / 0.12 = 0.05g
            # 设置 500e6 * 1e-9 = 0.5g，留有10倍余量支持生态系统发展
            "population": 500000000,  # 5亿（生产者应为消费者的10-100倍）
    ...
    },
    {
        ...
        "morphology_stats": {
            ...
            # 微藻 5亿 × 1纳克 = 0.5g
            # 鞭毛虫 200万 × 3纳克 = 0.006g
            # 比例：0.5 / 0.006 = 83:1，远高于12%生态效率需求
            "population": 2000000,  # 200万（从500万减少）
