...
class TraitConfig:
    ...
    TRAIT_PRESSURE_MAPPING = {
        # 温度相关
        "耐寒性": ("temperature", "cold"),    # temperature < 0 触发耐寒演化
        "耐热性": ("temperature", "hot"),     # temperature > 0 触发耐热演化
        "耐极寒": ("temperature", "cold"),
        
        # 水分相关
        "耐旱性": ("drought", "high"),        # drought > 0 触发耐旱演化
        "耐湿性": ("humidity", "high"),       # humidity > 0 触发耐湿演化
        ...
        # 光照相关
        "光照需求": ("light_reduction", "high"),  # 光照减少时，降低光照需求
        ...
        # 氧气相关
        "氧气需求": ("oxygen", "low"),        # 氧气减少时，降低氧气依赖
        "耐缺氧": ("oxygen", "low"),          # 新增：缺氧环境适应
        
        # 资源相关
        "资源利用效率": ("resource_decline", "high"),  # 资源减少时提高效率
        
        # 竞争相关
        "竞争能力": ("competition", "high"),  # 竞争压力下增强竞争力
        "攻击性": ("predator", "high"),       # 捕食压力下可能增加攻击性
        "防御性": ("predator", "high"),       # 捕食压力下增强防御
        
        # 运动相关
        "运动能力": ("predator", "high"),     # 捕食压力下可能增强运动能力
    }
