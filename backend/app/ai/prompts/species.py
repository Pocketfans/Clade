...
=== 演化规则 ===
1. **属性权衡**：增强某属性时，相关属性可能下降
2. **能量守恒**：变化总和应接近0或为小正数
3. **渐进原则**：单次变化幅度通常在±0.5以内
...
输出：
{{
    "analysis": "面对持续低温压力，该藻类正在演化出抗冻蛋白和不饱和脂肪酸合成能力，细胞膜流动性增强。同时光合效率略有下降，以换取低温存活能力。",
    "recommended_changes": {{
        "耐寒性": "+0.4",
        "光照需求": "-0.2"
    }},
...
4. **栖息地演化**：根据环境变化，可能改变栖息地类型（如海洋→海岸、陆生→两栖）。
