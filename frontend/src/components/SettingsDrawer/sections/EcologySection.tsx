  ...
  return (
    <div className="settings-section">
      <div className="section-header-bar">
        <div>
          <h2>🌿 生态平衡配置</h2>
          <p className="section-subtitle">控制种群动态和生态系统平衡的参数</p>
        </div>
        <ActionButton label="恢复默认" onClick={handleReset} variant="secondary" icon="↻" />
      </div>

      <SectionCard title="食物匮乏" icon="🍖" desc="猎物不足时的惩罚机制">
        <SliderRow
          label="匮乏阈值"
          desc="猎物丰富度低于此值时触发惩罚"
      ...
      <SectionCard title="竞争强度" icon="⚔️" desc="种间竞争的参数">
        <SliderRow
          label="基础竞争系数"
      ...
      <SectionCard title="营养传递" icon="🔗" desc="能量在食物链中的传递效率">
        <SliderRow
          label="传递效率"
          desc="能量从猎物传递到捕食者的比例"
      ...
      <SectionCard title="扩散行为" icon="🦅" desc="物种在地块间的分布">
      ...
      <SectionCard title="资源再生" icon="♻️" desc="地块资源的恢复机制">
        <SliderRow
          label="恢复速率"
      ...
      <SectionCard title="环境扰动" icon="🌪️" desc="随机环境波动">
        <SliderRow
          label="资源扰动"
